                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input v-model="botadd.title" type="text" class="form-control" id="add-bot-title" placeholder="Please enter your bot name">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="add-bot-title" class="form-label">Name</label>
                                                        <input v-model="bot.title" type="text" class="form-control" id="add-bot-title" placeholder="Please enter your bot name">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="add-bot-description" class="form-label">Description</label>
